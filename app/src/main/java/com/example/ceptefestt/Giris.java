...
public class Giris extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_email_Giris = findViewById(R.id.grs_email);
        edt_sifre_Giris = findViewById(R.id.grs_sifre);

        btn_giris_Yap = findViewById(R.id.btn_giriss);

        girisYetkisi = FirebaseAuth.getInstance();


        txt_kayitSayfasina_Git = findViewById(R.id.txt_kayitSayfasina_gitt);
        ...
        btn_giris_Yap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(str_emailGiris) || TextUtils.isEmpty(str_sifreGiris)) {
                    Toast.makeText(Giris.this, "Bütün alanları doldurun...", Toast.LENGTH_LONG).show();
                } else {
                    //Giriş yapma kodları kullanıcı adı ve şifre boş değilse
                                    ...
                                    if (task.isSuccessful()) {
                                        ...
                                        yolGiris.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                Intent intent = new Intent(Giris.this, harita.class);
                                        ...
                                        pdGiris.dismiss();
                                        Toast.makeText(Giris.this, "Giriş başarısız oldu!", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                }
